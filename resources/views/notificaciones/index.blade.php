            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                      <h1 class="text-3xl font-bold text-center my-10">Mis Notificaciones </h1>
                                ...
                                <div class="p-5 border-b border-gray-200 lg:flex justify-between lg:items-center">
                                    <div>
                                ...
                                @empty
                                    <p class="text-center text-gray-600 uppercase p-3">No tienes notificaciones</p>
